...
// });
  ...
  // TASK LIST
  // router.get('/v2/informant/task-list-form', (req, res) => {
  //   req.session.data = req.session.data || {};
  //   res.render('task-list', { data: req.session.data });
  // });

router.post('/v2/task-list-form', function (req, res) {
...
router.get('/v2/informant/task-list-inf-form', function (req, res) {
...
router.get('/v2/no-informant/task-list-noi-form', function (req, res) {
